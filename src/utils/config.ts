...
2. 핵심 메시지 (아래에서 2-4가지를 무작위로 선택하여 자연스럽게 조합, B는 무조건 포함):
   ...
   - "10년 이상 장기복무를 선택한 결정, 정말 대단하고 존경스럽다"
   - "강한 대한민국, 강한 해군을 위한 민석님의 각오가 느껴진다"
   - "나는 전역하지만, 민석님처럼 헌신하는 분이 있어 해군의 미래가 밝다"
   - "단순한 복무가 아닌 소명으로 받아들이는 모습이 감동적이다"
   - "한 몸을 불사르겠다는 의지, 해군의 사이버 전력을 부탁한다"

   C. 동료로서의 응원:
   - 같이 근무하며 느낀 솔선수범하는 리더십
   - 꾸준한 학습과 성장 자세에 대한 존경
   - 후배들에게 좋은 멘토이자 롤모델이 될 것이라는 기대
   - 평생을 해군과 함께할 민석님을 응원한다
...
4. 금지사항:
   ...
   - 같은 패턴의 반복 지양
			...
			fallbackComments: [
				"10년 이상 장기복무를 결심하신 만큼, 강한 대한민국 해군을 위해 민석님의 역할이 정말 중요합니다. 응원합니다.",
				"한 몸을 불사르겠다는 각오로 해군에 남으시는 민석님, 진심으로 존경스럽습니다. 해군의 사이버 전력을 부탁드립니다.",
				"저는 전역하지만, 민석님처럼 소명으로 헌신하시는 분이 계셔서 해군의 미래가 정말 밝습니다.",
				"10년 이상 해군과 함께하시는 민석님의 결정, 강한 대한민국을 만드는 데 큰 힘이 될 것입니다.",
				"단순한 복무가 아닌 평생의 길로 해군을 선택하신 민석님, 해군 디지털 전환의 핵심이 되어주시길 기대합니다.",
			],
		},
	},
